...
# alpha0_mu ~ normal(3.8, 0.4)
alpha0_mu_prior_mu <- 3.8
alpha0_mu_prior_sd <- 0.4

# alpha0_sigma ~ half_normal(0, 0.25)
alpha0_sigma_prior_mu <- 0
alpha0_sigma_prior_sd <- 0.25

# alphaD_mu ~ normal(0, 0.4)
alphaD_mu_prior_mu <- 0
alphaD_mu_prior_sd <- 0.4

# alphaD_sigma ~ half_normal(0, 0.25)
alphaD_sigma_prior_mu <- 0
alphaD_sigma_prior_sd <- 0.25

# beta0_mu ~ normal(0, 1.5)
beta0_mu_prior_mu <- 0
beta0_mu_prior_sd <- 1.5

# beta0_simga ~ half_normal(0, 0.5)
beta0_sigma_prior_mu <- 0
beta0_sigma_prior_sd <- 0.5

# betaD_mu ~ normal(0, 1)
betaD_mu_prior_mu <- 0
betaD_mu_prior_sd <- 1

# betaD_sigma ~ half_normal(0, 0.5)
betaD_sigma_prior_mu <- 0
betaD_sigma_prior_sd <- 0.5
