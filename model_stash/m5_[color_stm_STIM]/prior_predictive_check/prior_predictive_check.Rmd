...
Continuing from m1+m2, the most noticeable problem with the initial priors in m1 was that too many extremes values were being observed at the subject level, both in terms of cricSD and pMem. I think m2 achieved good priors on pMem, but I think in addition to narrowing variance priors on circSD I need to shift the mean prior. From m3, also narrow the circSD pre and post mean priors. m4 shifted mu_alpha0 from 4 -> 3.8, now try 3.7
...
\\
mu\_\alpha_0 &\sim Normal(3.7, 0.4)\\
...
Even better containment than m3, as expected
...
unsurprisingly narrower than m3, basically +/- 50. Which is good. 
...
Better containment than m3. This looks good enough.
...
Pre condition containment is much better, post condition containment is worse but expected I guess since some large effects are allowed.
...
maximum effects are more contained. Might be good enough.
